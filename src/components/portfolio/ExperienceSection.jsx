...
export default function ExperienceSection() {
  ...
  const responsibilities = [
    'Lead and instruct lab sections, teaching Python fundamentals to 40+ students',
    'Collaborate with professors in weekly meetings to improve course content',
    'Grade assignments, quizzes, and tests with detailed feedback',
    'Host office hours to support student understanding',
    'Revise and test course materials for better student reception',
  ];
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-1 p-4 rounded-xl bg-white/5">
              ...
              <p className="text-sm text-gray-400 mt-2">
                Creating solutions with GenAI, managing funds, and leading workshops using OpenAI API, LangChain, and vector stores.
              </p>
            </div>
            <div className="flex-1 p-4 rounded-xl bg-white/5">
              ...
              <p className="text-sm text-gray-400 mt-2">
                Active participant in martial arts training and competitions.
              </p>
            </div>
          </div>
        </motion.div>
